...
public class Dashboard extends javax.swing.JFrame {
    ...
    public void fillTable() throws SQLException, ClassNotFoundException{
        ...
        model.setRowCount(0);
        while(rs.next()){
            Object[] row = {rs.getString(1), rs.getString(2), rs.getInt(3) ,rs.getDouble(4)};
            model.addRow(row);
        }
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.database.InsertExist(codigo, nombre, cantidad, precio);
        try {
            try {
                fillTable();
                jTextField2.setText("");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            this.database.ActualizarProducto(nombre, cantidad, precio);
            jTextField6.setText("");
            jTextField5.setText("");
            jTextField4.setText("");
            this.fillTable();
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try{
            ...
            PreparedStatement pst = this.database.con.prepareStatement("select * from producto");
